...
public final class GreetingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "demo.helloworld.grpc.GreetingService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<demo.helloworld.grpc.HelloRequest,
      demo.helloworld.grpc.HelloResponse> METHOD_GREETING =
      io.grpc.MethodDescriptor.<demo.helloworld.grpc.HelloRequest, demo.helloworld.grpc.HelloResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "demo.helloworld.grpc.GreetingService", "greeting"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              demo.helloworld.grpc.HelloRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              demo.helloworld.grpc.HelloResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(demo.helloworld.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<demo.helloworld.grpc.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                demo.helloworld.grpc.HelloRequest,
                demo.helloworld.grpc.HelloResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public demo.helloworld.grpc.HelloResponse greeting(demo.helloworld.grpc.HelloRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<demo.helloworld.grpc.HelloResponse> greeting(
        demo.helloworld.grpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((demo.helloworld.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<demo.helloworld.grpc.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static final class GreetingServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return demo.helloworld.grpc.ExampleServices.getDescriptor();
    }
  }
